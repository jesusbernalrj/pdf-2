...
import createPDF from './GenerateTicketPDF'

const GenerateTicketVenta = async (output: any, _productos: any) => {
    ...
    //TABLA PRODUCTOS
    {
      ...
      table: {
        ...
        body: [
          ...
          // //   { text: `${product.stock}`, style: 'tProductsBody' },
          // //   { text: `${product.name}`, style: 'tProductsBody', alignment: 'left' },
          // //   { text: `${product.price}`, style: 'tProductsBody', alignment: 'right' },
          // //   { text: `${product.stock * product.price}`, style: 'tProductsBody', alignment: 'right' },
          // // ]),
        ],
      },
      layout: {
        hLineWidth: function (i: any, _node: any) {
          return i === 2 ? 0.5 : 0;
        },
        ...
        paddingTop: function (i: any, _node: any) {
          return i % 2 === 0 ? 10 : 1;
        },
      },
    },
  ...
  const response: any = await createPDF({ content }, output);
  return response
};

export default GenerateTicketVenta;